...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($old_pass) && !empty($new_pass) && !empty($confirm_pass)) {
        ...
        $check_old_pass = "SELECT password FROM employee WHERE email = '$_SESSION[email_emp]' AND password = '$old_pass'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($new_pass === $confirm_pass) {
                ...
                $confirm_passErr = "<p style='color:red'>* Confirm did not match new Password!</p>";
            }
